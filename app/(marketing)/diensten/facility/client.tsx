...
const services = [
  {
    ...
    description: "Langlopende overeenkomsten met overheden en instellingen.",
    features: [
  ...
  },
  {
    icon: Wrench,
    title: "Dakonderhoud",
    description: "Periodieke inspecties en herstellingen van daken.",
    features: [
  ...
  },
  {
    icon: Clock,
    title: "Interventies",
    description: "Herstellingen bij schade of dringende problemen.",
    features: [
  ...
  },
  {
    ...
    description: "Structurele verbeteringen en aanpassingen.",
    features: [
