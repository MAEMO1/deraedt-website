        ...
        <div className="container-wide relative pb-20 pt-48">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="label-overline">Bouw & Renovatie</span>
            </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-display text-2xl text-[#0C0C0C] mb-4">
                    {service.title}
                  </h3>

                  <p className="text-[#6B6560] mb-6">{service.description}</p>

                  <ul className="space-y-3">
                    {service.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3 text-sm text-[#0C0C0C]">
                        <CheckCircle className="w-4 h-4 text-[#9A6B4C] flex-shrink-0 mt-0.5" />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
