...
export const ROLE_PERMISSIONS = {
  ...
  actions: {
    ...
    'leads:delete': ['SALES', 'ADMIN', 'DIRECTIE'],
    'tenders:read': ['SALES', 'ADMIN', 'DIRECTIE'],
    'tenders:write': ['SALES', 'ADMIN', 'DIRECTIE'],
    'tenders:delete': ['ADMIN', 'DIRECTIE'],
    'jobs:read': ['HR', 'ADMIN', 'DIRECTIE'],
    'jobs:write': ['HR', 'ADMIN', 'DIRECTIE'],
    'applications:read': ['HR', 'ADMIN', 'DIRECTIE'],
    'applications:write': ['HR', 'ADMIN', 'DIRECTIE'],
    'applications:delete': ['HR', 'ADMIN', 'DIRECTIE'],
    'facility:read': ['OPERATIONS', 'ADMIN', 'DIRECTIE'],
    'facility:write': ['OPERATIONS', 'ADMIN', 'DIRECTIE'],
    'facility:delete': ['OPERATIONS', 'ADMIN', 'DIRECTIE'],
